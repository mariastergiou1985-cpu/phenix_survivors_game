...
// './BuildEngine.js?v=20260902090000'. Importing BuildEngine without that exact query yields a
...
const FC = await import('../../js/game/FusionCatalog.js?v=20260902090000');
const FE = await import('../../js/game/FusionEngine.js?v=20260902090000');
