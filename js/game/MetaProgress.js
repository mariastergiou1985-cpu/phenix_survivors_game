...
import { FUSION_DEFS, FUSION_MAX_TIER, fusionCost } from './FusionCatalog.js?v=20260902010000';
...
export const RELIC_DEFS = [
  ...
  { id:'ossuary_marrow',       name:'Ossuary Marrow',       type:'character',  cost:6,
    effect:'Skeleton: marrow-charged strikes (+0.5 Pulse Damage) and +5% Max HP.',
    req:null, reqChar:'skeleton warrior' },
  { id:'overheat_regulator',   name:'Overheat Regulator',   type:'character',  cost:6,
    effect:'Cyber Arm: regulated overdrive (+0.5 Pulse Damage) and +3% fire rate.',
    req:null, reqChar:'cyber arm hero' },
  { id:'seismic_knuckle',      name:'Seismic Knuckle',      type:'character',  cost:6,
    effect:'Brawler: +0.4 Pulse Damage and -3% contact damage taken.',
    req:null, reqChar:'brawler warrior' },
  { id:'null_shard_loop',      name:'Null Shard Loop',      type:'character',  cost:6,
    effect:'Phasewalker: Q/E recharge 6% faster and +2% move speed.',
    req:null, reqChar:'japan phasewalker' },
  { id:'rush_titan_pact',      name:'Titan Pact',           type:'arena',      cost:12,
    effect:'BOSS RUSH: every Titan pays DOUBLE Fragments — but all Titans gain +25% HP.',
    req:null, reqChar:null },
  { id:'rush_glass_vow',       name:'Glass Vow',            type:'arena',      cost:10,
    effect:'BOSS RUSH: +1.0 Pulse Damage while the rush runs — but you take +25% damage inside it.',
    req:null, reqChar:null },
