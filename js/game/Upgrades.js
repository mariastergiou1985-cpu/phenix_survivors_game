...
export const ALL_UPGRADES = [
  ...
  new UpgradeDefinition(
    'Firewall Protection', 'Firewall', '-2% contact damage',
    PURPLE, 5, p => { p.contactDamageReduction = Math.min(0.6, (p.contactDamageReduction || 0) + 0.02); }, 'F', 'common'   // decay mechanic removed — real armor now
  ),
  new UpgradeDefinition(
  ...
  new UpgradeDefinition(
    ...
    YELLOW, 8, p => { p._nexusCapBonus = (p._nexusCapBonus || 0) + 1; }, '▣', 'common'
  ),
  new UpgradeDefinition(
  ...
  new UpgradeDefinition('achievement_grid_stabilizer', 'Grid Stabilizer', 'Endless: -5% contact damage per level (capped)',
    CYAN, 2, p => { p.contactDamageReduction = Math.min(0.6, (p.contactDamageReduction || 0) + 0.05); }, '◈', 'legendary', null, 'grid_legend', true),
  ...
  new UpgradeDefinition('achievement_core_magnetizer', 'Core Magnetizer', 'Endless: +1 Nexus charge capacity per level',
    PURPLE, 2, p => { p._nexusCapBonus = (p._nexusCapBonus || 0) + 1; }, '◉', 'epic', null, 'core_defender', true),
  ...
  new UpgradeDefinition('achievement_core_hoarder', 'Core Hoarder', 'Endless: +2 Nexus charge capacity',
    PURPLE, 1, p => { p._nexusCapBonus = (p._nexusCapBonus || 0) + 2; }, '◉', 'epic', null, 'core_warden', true),
