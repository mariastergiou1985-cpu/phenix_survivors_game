...
export const TACTICAL_ID = Object.freeze({
  ...
  PISTON_RAMPART:    'tac_piston_rampart',
  SCRAP_COIL:        'tac_scrap_coil',
  QUAKE_PYLON:       'tac_quake_pylon',
  UMBRAL_SNARE:      'tac_umbral_snare',
  PHASE_BEACON:      'tac_phase_beacon',
  AXIOM_COMPASS:     'tac_axiom_compass',
  EMBER_SHRINE:      'tac_ember_shrine',
...
export const TACTICAL_DEFS = Object.freeze({
  ...
  [TACTICAL_ID.HUNTER_SENTRY]: {
    ...
    baseDamage:  80,     // was 72 (Maria balance pass)
    patrolRadius: 280,
    flySpeed:    3.0,
    tickRate:     0.6,
    duration:    15,
  ...
  [TACTICAL_ID.PROXIMITY_GRID]: {
    ...
    baseDamage:  78,     // was 60 (Maria balance pass)
    mineCount:   5,
    triggerRadius: 80,
    blastRadius:  140,
    duration:    20,
  ...
  // ╚═══════════════════════════════════════════════════════════════════╝
  [TACTICAL_ID.PISTON_RAMPART]: {
    id: TACTICAL_ID.PISTON_RAMPART,
    name: 'Piston Rampart',
    description: 'A rank of four hydraulic pistons plants itself and hammers the ground in alternating rhythm — a grinding zone nothing walks through.',
    character: 'cyber_arm_hero',
    behavior: TACTICAL_BEHAVIOR.STATIONARY_TOTEM,
    procedural: true,
    baseDamage: 82, aoeRadius: 180, tickRate: 1.1, duration: 12,
    color: '#ff9b3c',
  },
  [TACTICAL_ID.SCRAP_COIL]: {
    id: TACTICAL_ID.SCRAP_COIL,
  ...
  [TACTICAL_ID.QUAKE_PYLON]: {
    id: TACTICAL_ID.QUAKE_PYLON,
    name: 'Quake Pylon',
    description: 'A basalt pylon drives itself into the ground and HAMMERS — each blow sends a crack-ring rolling outward.',
    character: 'brawler_warrior',
    behavior: TACTICAL_BEHAVIOR.GROUND_SHOCKWAVE,
    procedural: true,
    baseDamage: 88, aoeRadius: 260, tickRate: 1.6, duration: 12,
    color: '#d8a24a',
  },
  [TACTICAL_ID.UMBRAL_SNARE]: {
    id: TACTICAL_ID.UMBRAL_SNARE,
    name: 'Umbral Snare',
  ...
  [TACTICAL_ID.PHASE_BEACON]: {
    id: TACTICAL_ID.PHASE_BEACON,
    name: 'Phase Beacon',
  ...
  [TACTICAL_ID.AXIOM_COMPASS]: {
    id: TACTICAL_ID.AXIOM_COMPASS,
    name: 'Axiom Compass',
    description: 'A giant geometric compass plants its needle and DRAWS — the circle it inscribes is a blade.',
    character: 'euclid_vector',
    behavior: TACTICAL_BEHAVIOR.GROUND_SHOCKWAVE,
    procedural: true,
    baseDamage: 80, aoeRadius: 240, tickRate: 1.4, duration: 12,
    color: '#8dff6a',
  },
  [TACTICAL_ID.EMBER_SHRINE]: {
    id: TACTICAL_ID.EMBER_SHRINE,
    name: 'Ember Shrine',
    description: 'A miniature obsidian shrine — blue oni-fire breathes out of its gate in slow arcs that burn whatever they lick.',
    character: 'oni_cataclysm_protocol',
    behavior: TACTICAL_BEHAVIOR.STATIONARY_TOTEM,
    procedural: true,
    baseDamage: 84, aoeRadius: 175, tickRate: 1.0, duration: 12,
    color: '#5a8cff',
  },
