import { Game } from './game/Game.js?v=20260902070000';
import { AudioManager } from './audio/AudioManager.js?v=20260902060000';
...
(function installQaBridge() {
  ...
  window.__phenixQA = {
    ...
    async activateBeEvolutionForProof(evolutionId) {
      ...
      let be;
      try { be = await import('./game/BuildEngine.js?v=20260902070000'); }
