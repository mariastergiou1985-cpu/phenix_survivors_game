import { Game } from './game/Game.js?v=20260902110000';
import { AudioManager } from './audio/AudioManager.js?v=20260902080000';
...
(function installQaBridge() {
  ...
  window.__phenixQA = {
    ...
    async activateBeEvolutionForProof(evolutionId) {
      ...
      let be;
      try { be = await import('./game/BuildEngine.js?v=20260902100000'); }
