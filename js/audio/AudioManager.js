...
export class AudioManager {
  constructor() {
    ...
    this._setupTrack('assets/audio/music/menu_theme.mp3?v=20260615121005', 0.28, a => { this._menuAudio     = a; });
    this._setupTrack('assets/audio/music/gameplay_theme.mp3?v=20260615121005', 0.20, a => { this._gameplayAudio = a; });
    // Endless-only track (dawn). Missing/failed load degrades safely (onerror warn).
    this._setupTrack('assets/audio/music/endless/dawn.wav?v=20260615121005', 0.20, a => { this._endlessAudio = a; });
  }
