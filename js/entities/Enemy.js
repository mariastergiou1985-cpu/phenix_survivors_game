...
import { DataCore } from './DataCore.js?v=20260614200716';
import { FloatingText } from './FloatingText.js';
import { drawGlow } from '../game/Effects.js?v=20260614200716';
...
export class Enemy {
  ...
  _loadSprite() {
    ...
    if (spriteFile) {
      ...
      this.sprite.src = `assets/enemies/${spriteFile}.png?v=20260614200716`;
    } else {
