import { Vec2, WIDTH, HEIGHT, WORLD_W, WORLD_H, WORLD_MARGIN, PLAYER_RADIUS, CYAN, WHITE, YELLOW, GREEN, BLUE, RED } from '../constants.js?v=20260615130629';
import { clamp, safeNormalize } from '../utils.js';
import { Projectile } from './Projectile.js?v=20260615130629';
...
export class Player {
  ...
  _loadCharacterSprite() {
    ...
    const ENDLESS_SPRITES = {
      japan_phasewalker:      'assets/characters/endless/japan_phasewalker.png?v=20260615130629',   // ?v bust: corrected transparency
